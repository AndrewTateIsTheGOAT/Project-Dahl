...
namespace Project_Dahl
{
    internal class CheckForFittingCars
    {
        public List<Cars> CarList = new List<Cars>
        {
            ...
            new Cars("Lyx", "Automat", 5000, "Diesel", 5200),
            new Cars("Lyx", "Manual", 5000, "Bensin", 4500),
            new Cars("Lyx", "Automat", 5000, "Bensin", 4900),
            new Cars("Lyx", "Manual", 10000, "Diesel", 4300),
            new Cars("Lyx", "Automat", 10000, "Diesel", 4300),
            ...
            new Cars("Sport", "Manual", 5000, "Bensin", 5000),
            new Cars("Sport", "Automat", 5000, "Bensin", 5000),
            new Cars("Sport", "Manual", 10000, "Diesel", 6000),
            new Cars("Sport", "Automat", 10000, "Diesel", 6000),
            new Cars("Sport", "Manual", 10000, "Bensin", 6000),
            new Cars("Sport", "Automat", 10000, "Bensin", 6000),
            new Cars("Sport", "Manual", 15000, "Diesel", 7000),
            new Cars("Sport", "Automat", 15000, "Diesel", 7000),
            new Cars("Sport", "Manual", 15000, "Bensin", 7000),
